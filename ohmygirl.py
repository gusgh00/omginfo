...
#embed text=";도움"
    ...
    if message.content.startswith(";도움"):
        ...
        embed1 = discord.Embed(title = "안녕하세요 미라클 봇입니다!", description = "명령어는 오마이걸 명령어와 이미지 명령어, 정보 명령어로 이루어져 있습니다.\n자세한 설명은 ;커맨드를 이용하면 나옵니다.\n즐겁게 사용해주시기 바랍니다.",color = 0xf4a6d7)
...
#songs lyrics
    ...
    if message.content.startswith(";가사") or message.content.startswith(";lyric") or message.content.startswith(";l"):
        ...
        lyr = message.content.split(" ")[1]
        songs = ['게릴라','너의','설레는','사랑속도','사르르','you','어느새','오늘도','슈가맨','Ma','모닝콜','sweet','who','타이밍','mr','sns','sunny']
        songcount = 17
        embedArray = []
